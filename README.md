...
<img src="voice-codex/src/assets/hero.png" alt="VoiceCodex command center">
...
VoiceCodex was built as part of the [JetBrains x OpenAI Hackathon](https://cerebralvalley.ai/events/~/e/jetbrains-x-openai-hack?modalCloseUrl=%2Fevents%2Fregistered) to explore what happens when OpenAI Realtime becomes the conversational interface for Codex, while WebStorm stays the developer's main workspace. The project was loved by many of the judges during private judging and received strong feedback, though it was not selected as one of the top 6 projects invited to present on stage.

VoiceCodex was designed and implemented before OpenAI later unveiled a [functional Realtime agent demo](https://www.youtube.com/shorts/NooDSUSjDvs) with side questions that do not interrupt the main execution, making VoiceCodex an early independent implementation of that interaction pattern.
